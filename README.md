...
### Real experiences
- <a href="https://img.shields.io/badge/Zoho-Cloud%20Software%20for%20Businesses-white?logo=zoho&logoColor=white&labelColor=red&color=grey">![Static Badge](https://img.shields.io/badge/Zoho-Cloud%20Software%20for%20Businesses-white?logo=zoho&logoColor=white&labelColor=red&color=grey&link=https%3A%2F%2Fwww.zoho.com)</a> At BambuGuazu (SOHO) I managed to successfully integrate Zoho Books, Zoho Bigin, and Zoho Forms into a single app using Zoho Flow, enhancing the potential of each web app and enabling seamless data reuse across them. I also created numerous custom functions in [Deluge](https://www.zoho.com/deluge/) to deliver a better experience for both users and managers. The company’s business website was integrated to allow customers to submit custom estimates, which were immediately ready to be converted in Zoho Books and Zoho Bigin, with an automated follow-up system for retargeting.
